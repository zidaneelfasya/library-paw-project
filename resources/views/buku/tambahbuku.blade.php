                        ...
                        <div class="card-body">
                            <div id="pay-invoice">
                                <div class="card-body">
                                    ...
                                    <hr>
                                <form action="{{url('buku/tambah/process')}}" method="post" novalidate="novalidate">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label for="inputKode" class="control-label mb-1">Kode Eksemplar</label>
                                        <input id="inputKode" name="kode_eksemplar" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                    </div>
                                        <div class="form-group has-success">
                                            <label for="inputJudul" class="control-label mb-1">Judul Buku</label>
                                            <input id="inputJudul" name="judul" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Masukkan judul" autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name-error">
